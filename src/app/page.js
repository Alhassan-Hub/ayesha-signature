...
export default function Home() {
  ...
  // Fading Review Timer (Changes every 6 seconds)
  useEffect(() => {
  ...
  // Fetch Products (Only featured 4)
  useEffect(() => {
      ...
      <div className="relative z-10 pt-32">
        ...
        <section className="relative h-[75vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden">
          ...
          <div className="pointer-events-auto reveal-text text-[#2C2424] z-10"> 
            <h1 className="text-5xl md:text-8xl font-light tracking-widest uppercase mb-4">
              Ayesha's
              <span className="block font-serif font-bold italic lowercase text-5xl md:text-8xl mt-2 text-[#DDA7A5]">
                signature
              </span>
            </h1>
                ...
                {products.map((product) => (
                  <div key={product.id} className="group cursor-pointer reveal-text flex flex-col bg-white p-3 rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex flex-col items-start gap-1 px-1">
                      <h3 className="text-xs md:text-sm font-serif font-bold group-hover:text-[#DDA7A5] transition-colors line-clamp-1">{product.name}</h3>
