...
export default function ShopPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FDF8F5] text-[#2C2424] font-sans overflow-x-hidden relative">
      ...
      {/* CART DRAWER */}
      <div className={`fixed inset-y-0 right-0 w-full md:w-[400px] bg-white z-[9998] transform transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] flex flex-col shadow-[-20px_0_50px_rgba(0,0,0,0.1)] ${isCartOpen ? 'translate-x-0' : 'translate-x-full'}`}>
      ...
      <div className="relative w-full h-[85vh] flex flex-col items-center justify-center z-10 bg-[#FDF8F5] pt-16">
